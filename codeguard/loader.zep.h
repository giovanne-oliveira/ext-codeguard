...
ZEND_BEGIN_ARG_INFO_EX(arginfo_codeguard_loader__testrequirements, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_codeguard_loader_getbinaryversion, 0, 0, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_codeguard_loader_canencryptcode, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_codeguard_loader_zephir_init_static_properties_codeguard_loader, 0, 0, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(codeguard_loader_method_entry) {
	...
	PHP_ME(CodeGuard_Loader, _testRequirements, arginfo_codeguard_loader__testrequirements, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC)
#else
...
#if PHP_VERSION_ID >= 80000
	PHP_ME(CodeGuard_Loader, getBinaryVersion, arginfo_codeguard_loader_getbinaryversion, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
#else
	PHP_ME(CodeGuard_Loader, getBinaryVersion, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
#endif
#if PHP_VERSION_ID >= 80000
	PHP_ME(CodeGuard_Loader, canEncryptCode, arginfo_codeguard_loader_canencryptcode, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
#else
